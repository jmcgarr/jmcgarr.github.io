<#include "header.ftl">
    ...
    <div class="row-fluid">
        ...
        <div class="span6 offset3">
            ...
            <p style="float:left">
                <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.mikemcgarr.com/${content.uri}" data-via="jMichaelMcGarr" data-lang="fr">Tweeter</a>
